...
<div id="holder_" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="solution_sliders.edit")
        <img src="{{ $solution_slider->image_desktop }}" alt="" style="height:5rem">
    @endif
</div>
</div>
...
<div id="holder_mobile" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="solution_sliders.edit")
        <img src="{{ $solution_slider->image_mobile }}" alt="" style="height:5rem">
    @endif
</div>
</div>

<div class="form-group col-sm-12">
  {{ Form::label('title1', 'Título [ES]:') }}
...
<div class="form-group col-sm-12">
  {{ Form::label('title2', 'Título [PT]:') }}
  {{ Form::text('title2', null, ['class' => 'form-control', 'placeholder' => 'Título']) }}
</div>
