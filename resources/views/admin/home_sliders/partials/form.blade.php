...
<div id="holder_" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="home_sliders.edit")
        <img src="{{ $home_slider->image_desktop }}" alt="" style="height:5rem">
    @endif
</div>
</div>
...
<div id="holder_mobile" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="home_sliders.edit")
        <img src="{{ $home_slider->image_mobile }}" alt="" style="height:5rem">
    @endif
</div>
</div>
