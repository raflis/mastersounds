...
<div class="layoutContent">
    <div class="container-fluid profile">
        <div class="row show-header">
            <div class="col-sm-12">
                <h1>
                    <i class="fas fa-home fa-xs"></i> <span>Meta Titles [PT]</span>
                </h1>
            </div>
        </div>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_title', 'Título para la página Principal [PT]:') }} <code>*</code>
                            {{ Form::text('meta_title[1]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_title', 'Título para la página Soluciones [PT]:') }} <code>*</code>
                            {{ Form::text('meta_title[2]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_title', 'Título para la página Episodios [PT]:') }} <code>*</code>
                            {{ Form::text('meta_title[3]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_title', 'Título para la página Noticias [PT]:') }} <code>*</code>
                            {{ Form::text('meta_title[4]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_title', 'Título para la página Contacto [PT]:') }} <code>*</code>
                            {{ Form::text('meta_title[5]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_title', 'Título para la página Newsletter [PT]:') }} <code>*</code>
