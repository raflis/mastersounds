...
<div class="layoutContent">
    <div class="container-fluid profile">
        <div class="row show-header">
            <div class="col-sm-12">
                <h1>
                    <i class="fas fa-home fa-xs"></i> <span>Meta Keywords [ES]</span>
                </h1>
            </div>
        </div>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_keyword', 'Keywords para la página Principal [ES]:') }} <code>*</code>
                            {{ Form::text('meta_keyword[1]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_keyword', 'Keywords para la página Soluciones [ES]:') }} <code>*</code>
                            {{ Form::text('meta_keyword[2]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_keyword', 'Keywords para la página Episodios [ES]:') }} <code>*</code>
                            {{ Form::text('meta_keyword[3]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_keyword', 'Keywords para la página Noticias [ES]:') }} <code>*</code>
                            {{ Form::text('meta_keyword[4]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_keyword', 'Keywords para la página Contacto [ES]:') }} <code>*</code>
                            {{ Form::text('meta_keyword[5]', null, ['class' => 'form-control', 'placeholder' => '', 'required']) }}
                        </div>

                        <div class="form-group col-sm-12">
                            {{ Form::label('meta_keyword', 'Keywords para la página Newsletter [ES]:') }} <code>*</code>
