...
<div class="layoutContent">
    <div class="container-fluid profile">
        <div class="row show-header">
            <div class="col-sm-12">
                <h1>
                    <i class="fas fa-home fa-xs"></i> <span>Meta Image [PT]</span>
                </h1>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="card shadow">
                    <div class="card-header">
                        <span>
                            Imagen por default al compartir URL en Redes [PT]
                        </span>
                    </div>
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-sm-12">
                          {!! Form::label('meta_image','Imagen de defecto para compartir redes sociales [PT]:',['class'=>'']) !!} <strong>(1200 x 627px)</strong> <code>*</code>
