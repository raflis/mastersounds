<div class="form-group col-sm-12">
  {!! Form::label('image', 'Selecciona una imagen:', ['class' => 'mt-3']) !!} <strong>(351 x 329 px)</strong><code>*</code>
...
<div id="holder_" style="margin-top:15px;max-height:120px;">
  @if (Route::currentRouteName()=="speakers.edit")
        <img src="{{ $speaker->image }}" alt="" style="height:6rem">
    @endif
</div>
</div>

<div class="form-group col-sm-12">
  {!! Form::label('flag', 'Selecciona una bandera:', ['class' => 'mt-3']) !!} <strong>(alto 40 px)</strong><code>*</code>
  <div class="input-group">
      <span class="input-group-btn">
      ...
      {!! Form::text('flag',null,['class'=>'form-control','id'=>'thumbnail_mobile']) !!}
  </div>
<div id="holder_mobile" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="speakers.edit")
        <img src="{{ $speaker->flag }}" alt="" style="height:1.5rem">
    @endif
</div>
</div>
...
<div class="form-group col-sm-12">
  {{ Form::label('position1', 'Posición [ES]:') }}
  {{ Form::text('position1', null, ['class' => 'form-control', 'placeholder' => 'Posición']) }}
</div>
<div class="form-group col-sm-12">
  {{ Form::label('position2', 'Posición [PT]:') }}
  {{ Form::text('position2', null, ['class' => 'form-control', 'placeholder' => 'Posición']) }}
</div>
